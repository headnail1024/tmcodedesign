...
function my_files()
{
    ...
    wp_enqueue_style('custom-google-fonts', '//fonts.googleapis.com/css2?family=Lato:wght@400;700&family=Source+Sans+Pro:wght@400;700&family=Quicksand:wght@300;400;500;600;700&display=swap');
